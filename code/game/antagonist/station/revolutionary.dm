...
/datum/antagonist/revolutionary
	...
	restricted_jobs = list("Internal Affairs Agent", "AI", "Cyborg", "Captain", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer", "Blueshield Guard")
	protected_jobs = list("Security Officer", "Warden", "Detective", "Department Guard")
