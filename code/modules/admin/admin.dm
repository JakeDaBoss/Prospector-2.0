...
/datum/admins/proc/show_player_panel(var/mob/M in mob_list)
	...
	var/body = "<html><center><head><title>Options for [M.key]</title></head>"
	...
	if (M.client)
		if(!istype(M, /mob/new_player))
			...
			body += {"<br><br>
				...
				<A href='?src=\ref[src];simplemake=observer;mob=\ref[M]'>Observer</A><br>
				...
				<A href='?src=\ref[src];simplemake=human;species=Xenomorph Queen;mob=\ref[M]'>Queen</A> \]<br>
				...
				<A href='?src=\ref[src];simplemake=human;species='Diona';mob=\ref[M]'>Diona</A> \]<br>
...
/proc/get_options_bar(whom, detail = 2, name = 0, link = 1, highlight_special = 1)
	...
	switch(detail)
		...
		if(2)	//Admins
			var/ref_mob = "\ref[M]"
			return "<b>[key_name(C, link, name, highlight_special)](<A HREF='?_src_=holder;adminmoreinfo=[ref_mob]'>?</A>) (<A HREF='?_src_=holder;adminplayeropts=[ref_mob]'>PP</A>) (<A HREF='?_src_=vars;Vars=[ref_mob]'>VV</A>) (<A HREF='?_src_=holder;subtlemessage=[ref_mob]'>SM</A>) ([admin_jump_link(M, src)]) (<A HREF='?_src_=holder;check_antagonist=1'>CA</A>) (<A HREF='?_src_=holder;takeadminhelp=\ref[M]'>TAKE</A>) (<A HREF='?_src_=holder;busy=\ref[M]'>BUSY</A>)</b>"

		if(3)	//Devs
			var/ref_mob = "\ref[M]"
			return "<b>[key_name(C, link, name, highlight_special)](<A HREF='?_src_=vars;Vars=[ref_mob]'>VV</A>)([admin_jump_link(M, src)]) (<A HREF='?_src_=holder;takeadminhelp=\ref[M]'>TAKE</A>) (<A HREF='?_src_=holder;busy=\ref[M]'>BUSY</A>)</b>"
